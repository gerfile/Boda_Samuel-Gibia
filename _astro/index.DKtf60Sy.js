...
var ve, Gr, Ve, Dt, Rt, nr, qn, Bt, mr, Kn, wt, ot, Zn, Jn = function() {
...
}, Qn = 1, rr = [], P = [], ft = [], xr = Date.now, fn = function(e, n) {
    return n
}, wi = function() {
    var e = mr.core
      , n = e.bridge || {}
    ...
    var t = function r(i) {
        if (i || i === 0) {
            ...
            i = r.v = Math.round(i) || (wt && wt.iOS ? 1 : 0),
            e(i),
            r.cacheID = P.cache,
            u && fn("ss", i)
        } else
            (n || P.cache !== r.cacheID || fn("ref")) && (r.cacheID = P.cache,
            r.v = e());
        return r.v + r.offset
    };
    return t.offset = 0,
    ...
    var r = e
      ...
      , h = function(v) {
        var $ = l
          , X = i
          , ne = xr();
        return (v || v === 0) && v !== r && Y(v),
        u === l || ne - l > x ? 0 : (r + (t ? X : -X)) / ((t ? ne : u) - $) * 1e3
    };
    return {
        update: Y,
        reset: M,
    ...
    mr = ve.core.globals().ScrollTrigger,
    mr && mr.core && wi()
}, ei = function(e) {
    return ve = e || Jn(),
    !Gr && ve && typeof document < "u" && document.body && (Ve = window,
    Dt = document,
    ...
    ,
    Bt = "onpointerenter"in nr ? "pointer" : "mouse",
    qn = J.isTouch = Ve.matchMedia && Ve.matchMedia("(hover: none), (pointer: coarse)").matches ? 1 : "ontouchstart"in Ve || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? 2 : 0,
    ot = J.eventTypes = ("ontouchstart"in Rt ? "touchstart,touchmove,touchcancel,touchend" : "onpointerdown"in Rt ? "pointerdown,pointermove,pointercancel,pointerup" : "mousedown,mousemove,mouseup,mouseup").split(","),
    setTimeout(function() {
        return Qn = 0
    }, 500),
    jn(),
...
var J = (function() {
    ...
    return e.init = function(t) {
        Gr || ei(ve) || console.warn("Please gsap.registerPlugin(Observer)"),
        mr || jn();
        var r = t.tolerance
          , i = t.dragMinimum
          , u = t.type
        ...
        x = x !== !1,
        p || (p = parseFloat(Ve.getComputedStyle(nr).lineHeight) || 22);
        var Ct, De, ze, O, q, Xe, Ne, a = this, He = 0, gt = 0, St = t.passive || !Y && t.passive !== !1, U = Ot(l, Le), ht = Ot(l, ae), kt = U(), Ft = ht(), ce = ~u.indexOf("touch") && !~u.indexOf("pointer") && ot[0] === "pointerdown", Tt = wr(l), K = l.ownerDocument || Dt, et = [0, 0, 0], Ze = [0, 0, 0], _t = 0, lr = function() {
            return _t = xr()
        }, te = function(m, F) {
            ...
            var m = a.deltaX = Dn(et)
              ...
              , f = Math.abs(m) >= r
              , b = Math.abs(F) >= r;
            ue && (f || b) && ue(a, m, F, et, Ze),
            f && (qe && a.deltaX > 0 && qe(a),
            N && a.deltaX < 0 && N(a),
            Ie && Ie(a),
            w && a.deltaX < 0 != He < 0 && w(a),
            He = a.deltaX,
            et[0] = et[1] = et[2] = 0),
            b && (Te && a.deltaY > 0 && Te(a),
            y && a.deltaY < 0 && y(a),
            g && g(a),
            ...
            a._vx.update(m),
            a._vy.update(F),
            x ? Ct || (Ct = requestAnimationFrame(vt)) : vt()
        }, Zt = function(m, F) {
            Me && !Ne && (a.axis = Ne = Math.abs(m) > Math.abs(F) ? "x" : "y",
            Xe = !0),
            Ne !== "y" && (et[2] += m,
            a._vx.update(m, !0)),
            Ne !== "x" && (Ze[2] += F,
            ...
            if (!te(m, 1)) {
                ...
                a.x = F,
                a.y = f,
                (C || (b || _) && (Math.abs(a.startX - F) >= i || Math.abs(a.startY - f) >= i)) && (ze = C ? 2 : 1,
                C || (a.isDragging = !0),
                Zt(b, _))
            }
        }, Lt = a.onPress = function(S) {
            te(S, 1) || S && S.button || (a.axis = Ne = null,
            De.pause(),
            a.isPressed = !0,
            S = fr(S),
            He = gt = 0,
        ...
        , D = a.onRelease = function(S) {
            if (!te(S, 1)) {
                ...
                !f && m && (a._vx.reset(),
                a._vy.reset(),
                Y && ee && ve.delayedCall(.08, function() {
                    if (xr() - _t > 300 && !S.defaultPrevented) {
                        if (S.target.click)
                            S.target.click();
                        else if (K.createEvent) {
                            var _ = K.createEvent("MouseEvents");
                            _.initMouseEvent("click", !0, !0, Ve, 1, b.screenX, b.screenY, b.clientX, b.clientY, !1, !1, !1, !1, 0, null),
        ...
        De = a._dc = ve.delayedCall(h || .25, Mr).pause(),
        a.deltaX = a.deltaY = 0,
        a._vx = dn(0, 50, !0),
        a._vy = dn(0, 50, !0),
        a.scrollX = U,
        ...
        Zn(this),
        a.enable = function(S) {
            return a.isEnabled || (Ae(Tt ? K : l, "scroll", pn),
            u.indexOf("scroll") >= 0 && Ae(Tt ? K : l, "scroll", rt, St, me),
            u.indexOf("wheel") >= 0 && Ae(l, "wheel", nt, St, me),
            (u.indexOf("touch") >= 0 && qn || u.indexOf("pointer") >= 0) && (Ae(l, ot[0], Lt, St, me),
            Ae(K, ot[2], D),
            Ae(K, ot[3], D),
            ee && Ae(l, "click", lr, !0, !0),
            Ke && Ae(l, "click", ar),
            ...
            Pe && Ae(l, Bt + "move", zt)),
            a.isEnabled = !0,
            a.isDragging = a.isGesturing = a.isPressed = O = ze = !1,
            a._vx.reset(),
            a._vy.reset(),
            kt = U(),
            Ft = ht(),
        ...
        a.disable = function() {
            ...
            }).length || Re(Tt ? K : l, "scroll", pn),
            a.isPressed && (a._vx.reset(),
            a._vy.reset(),
            Re(Q ? l : K, ot[1], Et, !0)),
            Re(Tt ? K : l, "scroll", rt, me),
            Re(l, "wheel", nt, me),
            Re(l, ot[0], Lt, me),
            Re(K, ot[2], D),
            Re(K, ot[3], D),
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var d, er, E, B, Ue, L, yn, Jr, Er, yr, dr, Yr, Ce, tn, gn, Ye, Rn, An, tr, ti, nn, ri, Oe, hn, ni, ii, Mt, _n, bn, ir, Cn, Qr, vn, on, Fr = 1, Se = Date.now, sn = Se(), je = 0, gr = 0, On = function(e, n, t) {
    var r = $e(e) && (e.substr(0, 6) === "clamp(" || e.indexOf("max") > -1);
    return t["_" + n + "Clamp"] = r,
...
}, Qt = Math.abs, ui = "left", ci = "top", Sn = "right", kn = "bottom", Wt = "width", Gt = "height", br = "Right", Cr = "Left", Sr = "Top", kr = "Bottom", re = "padding", Je = "margin", sr = "Width", Tn = "Height", le = "px", Qe = function(e) {
    ...
    if ($e(e)) {
        ...
        ~t && (e.indexOf("%") > t && (r *= n / 100),
        e = e.substr(0, t - 1)),
        e = r + (e in en ? en[e] * n : ~e.indexOf("%") ? parseFloat(e) * n / 100 : parseFloat(e) || 0)
    }
    return e
    ...
    return k += "position:" + ((X || p) && $ ? "fixed;" : "absolute;"),
    (X || p || !$) && (k += (r === ae ? Sn : kn) + ":" + (u + parseFloat(h)) + "px;"),
    l && (k += "box-sizing:border-box;text-align:left;width:" + l.offsetWidth + "px;"),
    v._isStart = W,
    ...
    (!Oe || !Oe.isPressed || Oe.startX > L.clientWidth) && (P.cache++,
    Oe ? Pr || (Pr = requestAnimationFrame(yt)) : yt(),
    je || qt("scrollStart"),
    je = Se())
}, an = function() {
    ii = E.innerWidth,
    ...
    P.cache++,
    (e === !0 || !Ce && !ri && !B.fullscreenElement && !B.webkitFullscreenElement && (!hn || ii !== E.innerWidth || Math.abs(E.innerHeight - ni) > E.innerHeight * .25)) && Jr.restart(!0)
}, Vt = {}, Pi = [], pi = function o() {
    ...
    for (var n = 0; n < Ge.length; n += 5)
        (!e || Ge[n + 4] && Ge[n + 4].query === e) && (Ge[n].style.cssText = Ge[n + 1],
    ...
    L.appendChild(ir),
    Cn = !Oe && ir.offsetHeight || E.innerHeight,
    L.removeChild(ir)
}, Nn = function(e) {
    ...
    n || Pn(),
    P.forEach(function(r) {
        ke(r) && (r.smooth && (r.target.style.scrollBehavior = "auto"),
        r(0))
    }),
    ...
    Pr = 0
}, wn = [ui, ci, kn, Sn, Je + kr, Je + br, Je + Sr, Je + Cr, "display", "flexShrink", "float", "zIndex", "gridColumnStart", "gridColumnEnd", "gridRowStart", "gridRowEnd", "gridArea", "justifySelf", "alignSelf", "placeSelf", "order"], qr = wn.concat([Wt, Gt, "boxSizing", "max" + sr, "max" + Tn, "position", Je, re, re + Sr, re + br, re + kr, re + Cr]), Di = function(e, n, t) {
    or(t);
    var r = e._gsap;
    if (r.spacerIsNative)
        or(r.spacerState);
    ...
    ke(e) && (e = e(p)),
    $e(e) && e.substr(0, 3) === "max" && (e = h + (e.charAt(4) === "=" ? $r("0" + e.substr(3), t) : 0));
    ...
    _r(e))
        ...
        W = Be(n, p) || L,
        k = xt(W) || {},
        (!k || !k.left && !k.top) && Qe(W).display === "none" && (y = W.style.display,
        W.style.display = "block",
        k = xt(W),
        y ? W.style.display = y : W.style.removeProperty("display")),
        qe = $r(ge[0], k[r.d]),
        N = $r(ge[1] || "0", t),
        e = k[r.p] - x[r.p] - Y + qe + i - N,
        l && Ur(l, N, r, t - N < 20 || l._isStart && N > 20),
        t -= t - N
    }
    if (v && (p[v] = e || -.001,
    e < 0 && (e = 0)),
    u) {
        var Te = e + t
          , Ie = u._isStart;
        X = "scroll" + r.d2,
        Ur(u, Te, r, Ie && Te > 20 || !Ie && (M ? Math.max(L[X], Ue[X]) : u.parentNode[X]) <= Te + 1),
        M && (x = xt(l),
        M && (u.style[r.op.p] = x[r.op.p] - r.op.m - u._offset + le))
    }
    return c && W && (X = xt(W),
    c.seek(h),
    ne = xt(W),
    ...
    c && c.seek($),
    c ? e : Math.round(e)
}, Oi = /(webkit|moz|length|cssText|inset)/i, Wn = function(e, n, t, r) {
    if (e.parentNode !== n) {
        var i = e.style, u, l;
        if (n === L) {
            e._stOrig = i.cssText,
            l = Qe(e);
            for (u in l)
                !+u && !Oi.test(u) && l[u] && typeof i[u] == "string" && u !== "0" && (i[u] = l[u]);
            i.top = t,
            i.left = r
        } else
            i.cssText = e._stOrig;
    ...
    return function(u) {
        var l = Math.round(e());
        return l !== r && l !== i && Math.abs(l - r) > 3 && Math.abs(l - i) > 3 && (u = l,
        t && t()),
        i = r,
        r = Math.round(u),
        r
    ...
    function o(n, t) {
        er || o.register(d) || console.warn("Please gsap.registerPlugin(ScrollTrigger)"),
        _n(this),
        this.init(n, t)
    }
    var e = o.prototype;
    return e.init = function(t, r) {
        ...
        s.vars = t,
        r = r || t.animation,
        "refreshPriority"in t && (ti = 1,
        t.refreshPriority === -9999 && (Tr = s)),
        pt.tweenScroll = pt.tweenScroll || {
            top: Gn(w, ae),
            left: Gn(w, Le)
        },
        s.tweenTo = Me = pt.tweenScroll[g.p],
        s.scrubDuration = function(f) {
            It = _r(f) && f,
            It ? D ? D.duration(f) : D = d.to(r, {
                ease: "expo",
                totalProgress: "+=0",
                inherit: !1,
                duration: It,
        ...
        ,
        r && (r.vars.lazy = !1,
        r._initted && !s.isReverted || r.vars.immediateRender !== !1 && t.immediateRender !== !1 && r.duration() && r.render(0, !0, !0),
        s.animation = r.pause(),
        r.scrollTrigger = s,
        s.scrubDuration(M),
        Et = 0,
        ...
        tt = Nt(tt) ? yr(tt.min, tt.max) : yr(tt, tt),
        rt = d.delayedCall(k.delay || It / 2 || .1, function() {
            var f = ee()
              , b = Se() - dt < 500
              , _ = Me.tween;
            if ((b || Math.abs(s.getVelocity()) < 10) && !_ && !tn && Ke !== f) {
                var C = (f - O) / U, fe = r && !ue ? r.totalProgress() : C, A = b ? 0 : (fe - Lt) / (Se() - dr) * 1e3 || 0, Z = d.utils.clamp(-C, 1 - C, Qt(A / 2) * A / .185), we = C + (k.inertia === !1 ? 0 : Z), V, H, z = k, it = z.onStart, G = z.onInterrupt, We = z.onComplete;
                if (V = Ct(we, s),
                _r(V) || (V = we),
                H = Math.max(0, Math.round(O + V * U)),
                f <= q && f >= O && H !== f) {
                    ...
                    Me(H, {
                        ...
                        onComplete: function() {
                            s.update(),
                            Ke = ee(),
                            r && !ue && (D ? D.resetTo("totalProgress", V, r._tTime / r._tDur) : r.progress(V)),
                            Et = Lt = r && !ue ? r.totalProgress() : s.progress,
                            W && W(s),
                            We && We(s)
                        }
                    }, f, Z * U, H - f - Z * U),
                ...
                s.isActive && Ke !== f && rt.restart(!0)
        }).pause()),
        p && (mn[p] = s),
        h = s.trigger = Be(h || c !== !0 && c),
        ...
        c && (v === !1 || v === Je || (v = !v && c.parentNode && c.parentNode.style && Qe(c.parentNode).display === "flex" ? !1 : re),
        s.pin = c,
        xe = d.core.getCache(c),
        xe.spacer ? ht = xe.pinState : (N && (N = Be(N),
        N && !N.nodeType && (N = N.current || N.nativeElement),
        xe.spacerIsNative = !!N,
        N && (xe.spacerState = Nr(N))),
        xe.spacer = ce = N || B.createElement("div"),
        ...
        lr = Zt[v + g.os2],
        K = d.getProperty(c),
        et = d.quickSetter(c, g.a, le),
        un(c, ce, Zt),
        Ft = Nr(c)),
        Q) {
            gt = Nt(Q) ? In(Q, zn) : zn,
            a = Br("scroller-start", p, w, g, gt, 0),
            He = Br("scroller-end", p, w, g, gt, 0, a),
            Tt = a["offset" + g.op.d2];
            var ar = Be(At(w, "content") || w);
            Xe = this.markerStart = Br("start", p, ar, g, gt, Tt, 0, y),
            Ne = this.markerEnd = Br("end", p, ar, g, gt, Tt, 0, y),
            y && (Jt = d.quickSetter([Xe, Ne], g.a, le)),
            !Ee && !(ft.length && At(w, "fixedMarkers") === !0) && (ki(ie ? L : w),
            d.set([a, He], {
                force3D: !0
            }),
            Mr = d.quickSetter(a, g.a, le),
            Kt = d.quickSetter(He, g.a, le))
        }
        if (y) {
        ...
        s.revert = function(f, b) {
            ...
            var _ = f !== !1 || !s.enabled
              , C = Ce;
            _ !== s.isReverted && (_ && (nt = Math.max(ee(), s.scroll.rec || 0),
            me = s.progress,
            zt = r && r.progress()),
            Xe && [Xe, Ne, a, He].forEach(function(fe) {
                return fe.style.display = _ ? "none" : "block"
            }),
            _ && (Ce = s,
            s.update(_)),
            c && (!qe || !s.isActive) && (_ ? Di(c, ce, ht) : un(c, ce, Qe(c), te)),
            _ || s.update(_),
            Ce = C,
            s.isReverted = _)
        }
        ...
        s.refresh = function(f, b, _, C) {
            if (!((Ce || !s.enabled) && !b)) {
                ...
                !Fe && oe && oe(s),
                Ce = s,
                Me.tween && !_ && (Me.tween.kill(),
                Me.tween = 0),
                D && D.pause(),
                $ && r && (r.revert({
                    kill: !1
                }).invalidate(),
                r.getChildren && r.getChildren(!0, !0, !1).forEach(function(Pt) {
                    return Pt.vars.immediateRender && Pt.render(0, !0, !0)
                })),
                s.isReverted || s.revert(!0, !0),
                s._subPinOffset = !1;
                var fe = Yt(), A = bt(), Z = y ? y.duration() : ct(w, g), we = U <= .01 || !U, V = 0, H = C || 0, z = Nt(_) ? _.end : t.end, it = t.endTrigger || h, G = Nt(_) ? _.start : t.start || (t.start === 0 || !h ? 0 : c ? "0 0" : "0 100%"), We = s.pinnedContainer = t.pinnedContainer && Be(t.pinnedContainer, s), st = h && Math.max(0, T.indexOf(s)) || 0, he = st, _e, ye, Xt, Dr, be, se, lt, rn, Mn, ur, at, cr, Rr;
                for (Q && Nt(_) && (cr = d.getProperty(a, g.p),
                Rr = d.getProperty(He, g.p)); he-- > 0; )
                    se = T[he],
                    se.end || se.refresh(0, 1) || (Ce = s),
                    lt = se.pin,
                    lt && (lt === h || lt === c || lt === We) && !se.isReverted && (ur || (ur = []),
                    ur.unshift(se),
                    se.revert(!0, !0)),
                    se !== T[he] && (st--,
                    he--);
                for (ke(G) && (G = G(s)),
                G = On(G, "start", s),
                O = Hn(G, h, fe, g, ee(), Xe, a, s, A, j, Ee, Z, y, s._startClamp && "_startClamp") || (c ? -.001 : 0),
                ke(z) && (z = z(s)),
                $e(z) && !z.indexOf("+=") && (~z.indexOf(" ") ? z = ($e(G) ? G.split(" ")[0] : "") + z : (V = $r(z.substr(2), fe),
                z = $e(G) ? G : (y ? d.utils.mapRange(0, y.duration(), y.scrollTrigger.start, y.scrollTrigger.end, O) : O) + V,
                it = h)),
                z = On(z, "end", s),
                q = Math.max(O, Hn(z || (it ? "100% 0" : Z), it, fe, g, ee() + V, Ne, He, s, A, j, Ee, Z, y, s._endClamp && "_endClamp")) || -.001,
                V = 0,
                he = st; he--; )
                    se = T[he],
                    lt = se.pin,
                    lt && se.start - se._pinPush <= O && !y && se.end > 0 && (_e = se.end - (s._startClamp ? Math.max(0, se.start) : se.start),
                    (lt === h && se.start - se._pinPush < O || lt === We) && isNaN(G) && (V += _e * (1 - se.progress)),
                    lt === c && (H += _e));
                if (O += V,
                q += V,
                s._startClamp && (s._startClamp += V),
                s._endClamp && !Fe && (s._endClamp = q || -.001,
                q = Math.min(q, ct(w, g))),
                U = q - O || (O -= .01) && .001,
                we && (me = d.utils.clamp(0, 1, d.utils.normalize(O, q, nt))),
                s._pinPush = H,
                Xe && V && (_e = {},
                _e[g.a] = "+=" + V,
                We && (_e[g.p] = "-=" + ee()),
                ...
                c && !(vn && s.end >= ct(w, g)))
                    ...
                    !Z && q > 1 && (at = (ie ? B.scrollingElement || Ue : w).style,
                    at = {
                        style: at,
                        value: at["overflow" + g.a.toUpperCase()]
                    },
                    ie && Qe(L)["overflow" + g.a.toUpperCase()] !== "scroll" && (at.style["overflow" + g.a.toUpperCase()] = "scroll")),
                    un(c, ce, _e),
                    Ft = Nr(c),
                    ye = xt(c, !0),
                    rn = Ee && Ot(w, Dr ? Le : ae)(),
                    v ? (te = [v + g.os2, U + H + le],
                    te.t = ce,
                    he = v === re ? jr(c, g) + U + H : 0,
                    he && (te.push(g.d, he + le),
                    ce.style.flexBasis !== "auto" && (ce.style.flexBasis = he + le)),
                    or(te),
                    We && T.forEach(function(Pt) {
                        Pt.pin === We && Pt.vars.pinSpacing !== !1 && (Pt._subPinOffset = !0)
                    }),
                    Ee && ee(nt)) : (he = jr(c, g),
                    he && ce.style.flexBasis !== "auto" && (ce.style.flexBasis = he + le)),
                    Ee && (be = {
                    ...
                    be[Wt] = be["max" + sr] = Math.ceil(ye.width) + le,
                    be[Gt] = be["max" + Tn] = Math.ceil(ye.height) + le,
                    be[Je] = be[Je + Sr] = be[Je + br] = be[Je + kr] = be[Je + Cr] = "0",
                    be[re] = _e[re],
                    be[re + Sr] = _e[re + Sr],
                    be[re + br] = _e[re + br],
                    be[re + kr] = _e[re + kr],
                    ...
                    nn(0)) : _t = U,
                    at && (at.value ? at.style["overflow" + g.a.toUpperCase()] = at.value : at.style.removeProperty("overflow-" + g.a));
                else if (h && ee() && !y)
                    for (ye = h.parentNode; ye && ye !== L; )
                        ye._pinOffset && (O -= ye._pinOffset,
                        q -= ye._pinOffset),
                        ye = ye.parentNode;
                ...
                rt.restart(!0)),
                Ce = 0,
                r && ue && (r._initted || zt) && r.progress() !== zt && r.progress(zt || 0, !0).render(r.time(), !0, !0),
                (we || me !== s.progress || y || $ || r && !r._initted) && (r && !ue && (r._initted || me || r.vars.immediateRender !== !1) && r.totalProgress(y && O < -.001 && !me ? d.utils.normalize(O, q, 0) : me, !0),
                s.progress = we || (De - O) / U === me ? 0 : me),
                c && v && (ce._pinOffset = Math.round(s.progress * _t)),
                D && D.invalidate(),
                isNaN(cr) || (cr -= d.getProperty(a, g.p),
        ...
        s.endAnimation = function() {
            ...
            r && (D ? D.progress(1) : r.paused() ? ue || pr(r, s.direction < 0, 1) : pr(r, r.reversed()))
        }
        ,
        ...
        s.update = function(f, b, _) {
            if (!(y && !_ && !f)) {
                var C = Fe === !0 ? nt : s.scroll(), fe = f ? 0 : (C - O) / U, A = fe < 0 ? 0 : fe > 1 ? 1 : fe || 0, Z = s.progress, we, V, H, z, it, G, We, st;
                if (b && (ze = De,
                De = y ? ee() : C,
                k && (Lt = Et,
                Et = r && !ue ? r.totalProgress() : A)),
                X && c && !Ce && !Fr && je && (!A && O < C + (C - ze) / (Se() - dr) * X ? A = 1e-4 : A === 1 && q > C + (C - ze) / (Se() - dr) * X && (A = .9999)),
                A !== Z && s.enabled) {
                    if (we = s.isActive = !!A && A < 1,
                    V = !!Z && Z < 1,
                    G = we !== V,
                    it = G || !!A != !!Z,
                    s.direction = A > Z ? 1 : -1,
                    s.progress = A,
                    it && !Ce && (H = A && !Z ? 0 : A === 1 ? 1 : Z === 1 ? 2 : 3,
                    ue && (z = !G && I[H + 1] !== "none" && I[H + 1] || I[H],
                    st = r && (z === "complete" || z === "reset" || z in r))),
                    Ie && (G || st) && (st || M || !r) && (ke(Ie) ? Ie(s) : s.getTrailing(Ie).forEach(function(Xt) {
                        return Xt.endAnimation()
                    })),
                    ue || (D && !Ce && !Fr ? (D._dp._time - D._start !== D._time && D.render(D._dp._time - D._start),
                    D.resetTo ? D.resetTo("totalProgress", A, r._tTime / r._tDur) : (D.vars.totalProgress = A,
                    D.invalidate().restart())) : r && r.totalProgress(A, !!(Ce && (dt || f)))),
                    c) {
                        if (f && v && (ce.style[v + g.os2] = lr),
                        !Ee)
                            et(hr(Ze + _t * A));
                        else if (it) {
                            if (We = !f && A > Z && q + 1 > C && C + 1 >= ct(w, g),
                            qe)
                                if (!f && (we || We)) {
                                    var he = xt(c, !0)
                                      , _e = C - O;
                                    ...
                                    Wn(c, ce);
                            or(we || We ? kt : Ft),
                            vt && A < 1 && we || et(Ze + (A === 1 && !We ? _t : 0))
                        }
                    }
                    k && !Me.tween && !Ce && !Fr && rt.restart(!0),
                    l && (G || ge && A && (A < 1 || !on)) && Er(l.targets).forEach(function(Xt) {
                        return Xt.classList[we || ge ? "add" : "remove"](l.className)
                    }),
                    u && !ue && !f && u(s),
                    it && !Ce ? (ue && (st && (z === "complete" ? r.pause().totalProgress(1) : z === "reset" ? r.restart(!0).pause() : z === "restart" ? r.restart(!0) : r[z]()),
                    u && u(s)),
                    (G || !on) && (x && G && ln(s, x),
                    Pe[H] && ln(s, Pe[H]),
                    ge && (A === 1 ? s.kill(!1, 1) : Pe[H] = 0),
                    G || (H = A === 1 ? 1 : 3,
                    Pe[H] && ln(s, Pe[H]))),
                    Te && !we && Math.abs(s.getVelocity()) > (_r(Te) ? Te : 2500) && (pr(s.callbackAnimation),
                    D ? D.progress(1) : pr(r, z === "reverse" ? 1 : !A, 1))) : ue && u && !Ce && u(s)
                }
                if (Kt) {
                    var ye = y ? C / y.duration() * (y._caScrollDist || 0) : C;
                    Mr(ye + (a._isFlipped ? 1 : 0)),
                    Kt(ye)
                }
        ...
        s.kill = function(f, b) {
            ...
            b || r.kill()),
            Xe && [Xe, Ne, a, He].forEach(function(C) {
    ...
    o.disable = function(t, r) {
        ...
        pe(B, "touchcancel", ut),
        pe(L, "touchstart", ut),
        Ir(pe, B, "pointerdown,touchstart,mousedown", Fn),
        Ir(pe, B, "pointerup,touchend,mouseup", Ln),
        Jr.kill(),
        Lr(pe);
    ...
    o.enable = function() {
        ...
        L = B.body,
        d && (Er = d.utils.toArray,
        yr = d.utils.clamp,
        _n = d.core.context || ut,
        nn = d.core.suppressOverwrites || ut,
        bn = E.history.scrollRestoration || "auto",
        xn = E.pageYOffset || 0,
        ...
        L)) {
            ...
            J.register(d),
            o.isTouch = J.isTouch,
            Mt = J.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent),
            hn = J.isTouch === 1,
            de(E, "wheel", jt),
            yn = [E, B, Ue, L],
            d.matchMedia ? (o.matchMedia = function(x) {
                var Y = d.matchMedia(), M;
                for (M in x)
                    Y.add(M, x[M]);
                return Y
            }
            ...
            de(B, "touchcancel", ut),
            de(L, "touchstart", ut),
            Ir(de, B, "pointerdown,touchstart,mousedown", Fn),
            Ir(de, B, "pointerup,touchend,mouseup", Ln),
            gn = d.utils.checkPrefix("transform"),
            qr.push(gn),
            er = Se(),
            Jr = d.delayedCall(.2, Ht).pause(),
            tr = [B, "visibilitychange", function() {
                var x = E.innerWidth
                  , Y = E.innerHeight;
                B.hidden ? (Rn = x,
                An = Y) : (Rn !== x || An !== Y) && vr()
            }
            , B, "DOMContentLoaded", Ht, E, "load", Ht, E, "resize", vr],
            Lr(de),
    ...
    o.config = function(t) {
        ...
        "ignoreMobileResize"in t && (hn = o.isTouch === 1 && t.ignoreMobileResize),
        "autoRefreshEvents"in t && (Lr(pe) || Lr(de, t.autoRefreshEvents || "none"),
    ...
    o.scrollerProxy = function(t, r) {
        var i = Be(t)
          ...
          , l = Ut(i);
        ~u && P.splice(u, l ? 6 : 2),
        r && (l ? ft.unshift(E, r, L, r, Ue, r) : ft.unshift(i, r))
    }
    ,
...
R.saveStyles = function(o) {
    return o ? Er(o).forEach(function(e) {
        if (e && e.style) {
            var n = Ge.indexOf(e);
            n >= 0 && Ge.splice(n, 5),
            Ge.push(e, e.style.cssText, e.getBBox && e.getAttribute("transform"), d.core.getCache(e), _n())
        }
    }) : Ge
}
;
...
R.batch = function(o, e) {
    var n = [], t = {}, r = e.interval || .016, i = e.batchMax || 1e9, u = function(x, Y) {
        var M = []
          , h = []
...
var $n = function(e, n, t, r) {
    return n > r ? e(r) : n < 0 && e(0),
    t > r ? (r - n) / (t - n) : t < 0 ? n / (n - t) : 1
}, cn = function o(e, n) {
    n === !0 ? e.style.removeProperty("touch-action") : e.style.touchAction = n === !0 ? "auto" : n ? "pan-" + n + (J.isTouch ? " pinch-zoom" : "") : "none",
    e === Ue && o(L, n)
}, Wr = {
    auto: 1,
    scroll: 1
    ...
    if (!u._isScrollT || l - u._isScrollT > 2e3) {
        for (; i && i !== L && (i.scrollHeight <= i.clientHeight && i.scrollWidth <= i.clientWidth || !(Wr[(p = Qe(i)).overflowY] || Wr[p.overflowX])); )
            i = i.parentNode;
        u._isScroll = i && i !== t && !Ut(i) && (Wr[(p = Qe(i)).overflowY] || Wr[p.overflowX]),
        u._isScrollT = l
    }
    (u._isScroll || r === "x") && (n.stopPropagation(),
    n._gsapAllow = !0)
}, vi = function(e, n, t, r) {
    return J.create({
        target: e,
...
}, Fi = /(input|label|select|textarea)/i, Un, Vn = function(e) {
    ...
    var n = e, t = n.normalizeScrollX, r = n.momentum, i = n.allowNestedScroll, u = n.onRelease, l, p, x = Be(e.target) || Ue, Y = d.core.globals().ScrollSmoother, M = Y && Y.get(), h = Mt && (e.content && Be(e.content) || M && e.content !== !1 && !M.smooth() && M.content()), c = Ot(x, ae), v = Ot(x, Le), $ = 1, X = (J.isTouch && E.visualViewport ? E.visualViewport.scale * E.visualViewport.width : E.outerWidth) / E.innerWidth, ne = 0, W = ke(r) ? function() {
        return r(l)
    }
    : function() {
        return r || 2.8
    }
    , ge, k, qe = vi(x, e.type, !0, i), N = function() {
        return k = !1
    }, y = ut, Te = ut, Ie = function() {
        p = ct(x, ae),
        Te = yr(Mt ? 1 : 0, p),
        t && (y = yr(0, ct(x, Le))),
        ge = $t
        ...
        Ie(),
        w.isActive() && w.vars.scrollY > p && (c() > p ? w.progress(1) && c(p) : w.resetTo("scrollY", p))
    };
    return h && d.set(h, {
        y: "+=0"
    }),
    ...
    e.onPress = function() {
        k = !1;
        var I = $;
        $ = hr((E.visualViewport && E.visualViewport.scale || 1) / X),
        w.pause(),
        I !== $ && cn(x, $ > 1.01 ? !0 : t ? !1 : "x"),
        pt = v(),
        ie = c(),
    ...
    e.onRelease = e.onGestureStart = function(I, Q) {
        ...
        !Q)
            ...
            var j = W(), s, oe;
            t && (s = v(),
            oe = s + j * .05 * -I.velocityX / .227,
            j *= $n(v, s, oe, ct(x, Le)),
            w.vars.scrollX = y(oe)),
            s = c(),
            oe = s + j * .05 * -I.velocityY / .227,
            j *= $n(c, s, oe, ct(x, ae)),
            w.vars.scrollY = Te(oe),
            w.invalidate().duration(j).play(.01),
            (Mt && w.vars.scrollY >= p || s >= p - 1) && d.to({}, {
                onUpdate: Pe,
                duration: j
            })
        }
    ...
    e.onChange = function(I, Q, j, s, oe) {
        if ($t !== ge && Ie(),
        Q && t && v(y(s[2] === Q ? pt + (I.startX - I.x) : v() + Q - s[1])),
        j) {
            c.offset && g();
            var Yt = oe[2] === j
    ...
    e.onDisable = function() {
        cn(x, !0),
        pe(E, "resize", Pe),
        R.removeEventListener("refresh", Pe),
        qe.kill()
    }
    ,
...
R.normalizeScroll = function(o) {
    ...
    return Oe && Oe.target === e.target && Oe.kill(),
    Ut(e.target) && (Oe = e),
    e
}
;
